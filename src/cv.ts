  ...
  work: [
    {
      ...
      endDate: undefined, //new Date(`2025-12-31`),
      summary: `Lead and mentor teams of IFS's transition from .NET monoliths to Golang microservices.`,
      highlights: [
        `Build new teams to deliver new services in an unfamiliar language to the organization (Golang).`,
        `Drove the creation and evangilization of Golang guidelines and best practices.`,
        `Introduced an API first methodology.`,
        `Helped improve asynchronous architecture.`,
        `Successfully helped design and create two new central services that other teams would depend on.`,
        `Key technologies: Golang / MongoDB / Kafka / Kubernetes`,
      ],
    },
    {
      name: `BP`,
