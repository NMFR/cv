  ...
  work: [
    {
      ...
      summary: `Lead and mentor teams on IFS's shift from .NET monoliths to Golang microservices.`,
      highlights: [
        `Built and mentored new teams to deliver new services in an unfamiliar language to the organization (Golang).`,
        `Drove the creation and evangilization of Golang best practices and guidelines.`,
        `Introduced an API first methodology with code generation from Open API specs.`,
        `Decreased API development dependencies by introducing Open API specs mock generation tools.`,
